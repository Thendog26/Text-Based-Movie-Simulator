...
int main(){
	srand(time(NULL)); //Sets inprogram time for rand() functions
        ...
        cout << endl << "## Parent class testing ##" << endl; //a message to show that it is a test report in the terminal
        cout << endl;
        // Variable initiallising
        Movie *Mov = new Movie; //creating a movie pointer and assignig a movie class to the location.
        ...
        bool avaliability = Mov -> get_avaliability(); //setting the newmovies' avaliability to alternate 20% of the time like the default one.
        string cute_answer;
